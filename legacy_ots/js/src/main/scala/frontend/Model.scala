...
trait Bindings {
  ...
  implicit val blank4: Blank[viewData.AdminCourseViewData] = Blank.Simple(viewData.AdminCourseViewData("Loading course..", "NO TITLE", None,  CoursePiece.emptyCourse , Seq(), false))
