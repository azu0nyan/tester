import frontend.LandingPageState
...
object JsMain {
  ...
  def main(args: Array[String]): Unit = {
    document.addEventListener("DOMContentLoaded", { (e: dom.Event) =>
      println("Dom content loaded, starting app...")
      val appRoot = document.body
//      frontend.applicationInstance.goTo(LandingPageState, true)
      frontend.applicationInstance.run(appRoot)
    })
