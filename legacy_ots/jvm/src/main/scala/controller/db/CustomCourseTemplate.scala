...
object CustomCourseTemplate {
  ...
  def apply(uniqueAlias: String,courseTitle: String, description: Option[String], allowedForAll: Boolean, timeLimitSeconds: Option[Int], allowedInstances: Option[Int], courseData: CourseMainPiece, problemAliasesToGenerate: Seq[String]): CustomCourseTemplate =
...
case class CustomCourseTemplate(
                                 ...
                                 override val courseData: CourseMainPiece,
